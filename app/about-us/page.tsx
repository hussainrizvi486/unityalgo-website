            ...
            <div className="container mx-auto max-w-6xl text-center relative z-10">
               ...
               >
                  ...
                  <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-brand-900 mb-8 text-balance">
                     Architecting the <br />
                     <span className="bg-linear-to-r from-brand-600 to-brand-400 bg-clip-text ">
                        Future of Business
                     </span>
                  </h1>
               ...
               <div className="grid md:grid-cols-3 gap-4">
                  {[
                     ...
                     <motion.div
                        ...
                        className="p-8 rounded-md bg-white shadow-sm hover:shadow-xl hover:cursor-pointer hover:shadow-brand-900/5 transition-all duration-300 group"
                     >
                        <div className="w-14 h-14 bg-brand-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-brand-600 transition-colors">
